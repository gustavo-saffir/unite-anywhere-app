...
const AIMentorChat = ({ devotionalId, devotionalContext, onClose }: AIMentorChatProps) => {
  ...
  const initializeConversation = async () => {
    try {
      ...
      setMessages([{
        role: 'assistant',
        content: '🙏 Olá! Sou seu Mentor Espiritual IA. Estou aqui para ajudá-lo a refletir sobre o devocional de hoje e apoiá-lo em sua jornada de fé. Como posso ajudá-lo?\n\n*Lembre-se: sou uma ferramenta de apoio, não substituo o papel do seu pastor ou líder espiritual.*'
      }]);
    } catch (error) {
    ...
    <Card className="fixed inset-4 md:inset-auto md:right-4 md:bottom-4 md:w-[400px] md:h-[600px] z-50 flex flex-col shadow-celestial">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border bg-gradient-celestial">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-primary-foreground">Mentor IA</h3>
        </div>
        <Button
          variant="ghost"
          size="icon"
